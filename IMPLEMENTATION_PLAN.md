...
### ✅ 페이즈 3) MVP(개요 페이지 1개) 구현 (1일) - 완료
- UI
  - ✅ 사이드바 필터: 요일, 호선, 역 검색, 방향, 시간대
  - ✅ 필터 실시간 연동 (필터링된 데이터 건수 표시)
- 시각화(최소 구성)
  - ✅ KPI 카드 4개: 피크 혼잡도/평균 혼잡도/피크 시간/분석 건수
  - ✅ 라인차트: 시간대별 혼잡도 추이 (Altair, 피크 시간 강조)
  - ✅ 막대차트: 가장 혼잡한 역 TOP 10 (Altair, 호선별 색상 구분)
- 추가 기능
  - ✅ 상세 데이터 expander (시간대별/TOP 10)
  - ✅ 툴팁 및 사용 가이드
- 산출물
  - ✅ `app.py` 완전한 MVP 대시보드
